...
namespace iTalk
{
    ...
    class iTalk_TextBox_Small : Control
    {
        ...
        public iTalk_TextBox_Small()
        {
            ...
            P1 = new Pen(Color.FromArgb(240,240,240)); // P1 = Border color
            B1 = new SolidBrush(Color.FromArgb(240, 240, 240)); // B1 = Rect Background color
            BackColor = Color.Transparent;
    ...
    class iTalk_RadioButton : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            LinearGradientBrush LGB = new LinearGradientBrush(new Rectangle(new Point(0, 0), new Size(15, 15)), Color.White, Color.White, 90);
            _G.FillEllipse(LGB, new Rectangle(new Point(0, 0), new Size(15, 15)));

            GraphicsPath GP = new GraphicsPath();
            GP.AddEllipse(new Rectangle(0, 0, 15, 15));
            _G.SetClip(GP);
            _G.ResetClip();

            // Draw ellipse border
            _G.DrawEllipse(new Pen(Color.RoyalBlue), new Rectangle(new Point(0, 0), new Size(15, 15)));

            // Draw an ellipse inside the body
            if (_Checked)
            {
                SolidBrush EllipseColor = new SolidBrush(Color.RoyalBlue);
                _G.FillEllipse(EllipseColor, new Rectangle(new Point(3, 3), new Size(9, 9)));
            }
            // Draw the string specified in 'Text' property
            _G.DrawString(Text, Font, new SolidBrush(Color.RoyalBlue), 16, 8, new StringFormat { LineAlignment = StringAlignment.Center });
    ...
    class iTalk_ComboBox : ComboBox
    {
        ...
        private Color _HoverSelectionColor = Color.FromArgb(225,225,225);
        ...
        protected override void OnDrawItem(DrawItemEventArgs e)
        {
            ...
            if (!(e.Index == -1))
            {
                e.Graphics.DrawString(GetItemText(Items[e.Index]), e.Font, Brushes.RoyalBlue, e.Bounds);
            }
        }
        ...
        public iTalk_ComboBox()
        {
            ...
            ItemHeight = 20;
            DropDownHeight = 100;
            Font = new Font("Century Gothic", 8.15F, FontStyle.Regular);
        }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            LGB = new LinearGradientBrush(ClientRectangle, Color.White, Color.White, 90f);
            ...
            e.Graphics.DrawPath(new Pen(Color.White), GP);
            // Draw string
            e.Graphics.DrawString(Text, Font, new SolidBrush(Color.RoyalBlue), new Rectangle(3, 0, Width - 20, Height), new StringFormat
            {
                LineAlignment = StringAlignment.Center,
            ...
            e.Graphics.DrawLine(new Pen(Color.RoyalBlue, 2), new Point(Width - 14, 10), new Point(Width - 10, 14));
            e.Graphics.DrawLine(new Pen(Color.RoyalBlue, 2), new Point(Width - 10, 14), new Point(Width - 6, 10));
            e.Graphics.DrawLine(new Pen(Color.RoyalBlue), new Point(Width - 10, 15), new Point(Width - 10, 14));
